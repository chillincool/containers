...
func Test(t *testing.T) {
	image := testhelpers.GetTestImage("ghcr.io/chillincool/containers/kometa:local")
	
	ctx := context.Background()
	
	// Kometa is a script that runs and exits, not a service
	...
	t.Log("Kometa --help executed successfully")
}
