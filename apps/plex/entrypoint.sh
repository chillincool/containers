...
if [[ -z "$(getPref "TranscoderTempDirectory")" ]]; then
    echo "Setting Transcoder directory"
...
# https://github.com/uglymagoo/plex-env-vars-docs
# Plex env vars use PLEX_PREFERENCE_ and then the full key below
# The format is:
# PLEX_PREFERENCE_<PreferenceKey>="<PreferenceValue>"
# The "=" is already in the pref key for some reason. This is likely due to bash env var injection
